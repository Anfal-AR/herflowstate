...
const CACHE_NAME = `herflowstate-v${SW_VERSION}`;
...
define(['./workbox-e43f5367'], (function (workbox) { 'use strict';
      ...
      caches.keys().then(cacheNames => {
        return Promise.all(
          cacheNames.map(cacheName => {
            if (cacheName !== CACHE_NAME && cacheName.startsWith('herflowstate-')) {
  ...
  workbox.registerRoute("/", new workbox.NetworkFirst({
    "cacheName": `start-url-v${SW_VERSION}`,
    plugins: [{
